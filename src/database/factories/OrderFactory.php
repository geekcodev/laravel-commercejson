...
class OrderFactory extends CommerceJsonFactory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'comment' => null,
            'customer_name' => null,
            'customer_phone' => static::phone(),
            'customer_email' => static::email(),
            ...
            'totals_subtotal_currency' => 'RUB',
            'totals_discount_amount' => 0.00,
            'totals_discount_currency' => 'RUB',
            'totals_delivery_amount' => 500.00,
            'totals_delivery_currency' => 'RUB',
            'totals_tax_amount' => 0.00,
            'totals_tax_currency' => 'RUB',
            'totals_total_amount' => 500.00,
            'totals_total_currency' => 'RUB',
            'created_at' => now(),
            'updated_at' => now(),
            'deleted_at' => null,
        ];
